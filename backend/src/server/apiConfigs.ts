...
export const getAthleteAuthConfig = (
...
export const getAllEntriesConfig: (
  currentAccessToken: string
) => AxiosRequestConfig = (currentAccessToken) => {
  return {
...
export const getRefreshedAccessTokenConfig: (
  refreshToken: string
) => AxiosRequestConfig = (refreshToken) => {
  return {
    method: "POST",
